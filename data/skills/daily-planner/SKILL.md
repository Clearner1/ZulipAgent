...
{"type": "one-shot", "stream": "planner", "topic": "daily", "text": "任务截止追踪：「任务标题」已到截止时间 HH:MM，请检查任务是否完成，如未完成则询问用户是否已完成任务并提供调整建议。", "at": "YYYY-MM-DDTHH:MM:SS+08:00"}
EOF
```
...
3. 如果未完成 → 友好询问用户是否已完成任务，例如："读 Rust Book 的时间到了，你是否已经完成了任务？如果还没有，需要我帮你调整时间或者提供其他帮助吗？"
